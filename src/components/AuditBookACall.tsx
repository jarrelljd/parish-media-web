...
export default function AuditBookACall({ role }: { role?: string }) {
    ...
    <>
      <div className="mx-auto max-w-2xl text-center">
        ...
        <h1 className="mt-8 text-balance font-serif text-3xl font-semibold text-navy sm:text-4xl">
          {isPriest
            ? "Your Audit Request Is In, Father."
            : "Your Audit Request Is In."}
        </h1>
        <p className="mt-4 text-pretty text-lg text-navy/70">
          {isPriest
            ? "While you wait for your video, schedule your complimentary 30-minute parish outreach consult."
      ...
      <div className="mx-auto mt-10 max-w-2xl rounded-2xl border border-navy/10 bg-white p-8 shadow-sm">
        <p className="text-pretty text-navy/80">
          Thank you for requesting a free social media audit. I&rsquo;ll
          personally review your page and send you a short video walkthrough
          soon.
        </p>
        ...
        {isPriest ? (
          <>
            <p className="mt-4 text-pretty text-navy/80">
              ...
              to talk through what the audit finds.
            </p>
